...
public class PathfindingOwn: MonoBehaviour
{
    ...
    public Vector3? getNextPosition(Vector3 startPos, Vector3 endPos)
    {
        ...
        {
            return currentNearestNode.bestNeighbour.position;
        }
    ...
    {
        Vector3? nextpos = getNextPosition(startPos, endPos);
        if (nextpos == null)
            return null;
        return ((Vector3)nextpos - startPos).normalized;
    }
